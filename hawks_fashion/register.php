...
include 'Functions/customer_db.php';
 ...
 <?php if (isset($_POST['submit'])) {
   add_new_customer($_POST['fname'], $_POST['lname'], $_POST['email'], $_POST['user'], $_POST['pass']);
   header('location: login.php');
 } ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <title>Hawk's Fashion Registration</title>
  <meta charset="utf-8">
...
<article>
<div class="container">
  <h2>Hawk's Fashion User Registration</h2>
