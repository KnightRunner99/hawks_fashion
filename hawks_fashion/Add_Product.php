    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse ">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Edit_Accounts.php">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <form method="post">
        <div class="form-group">
          ...
          <input type="text" name="product" class="form-control" placeholder="Name of Product" required>
        </div>
        <div class="form-group">
          <label>Quantity</label>
          <input type="number" class="form-control" name="quantity" min="0" max="100" placeholder="Number in stock (0-100)"required >
        </div>
        <div class="form-group">
          <label>Price</label>
          <div class="input-group mb-3">
            ...
            <input class="form-control" name="price" type="number" min="1.00" step=".01" value="1.00" required />
          </div>
        </div>
        <div class="form-group">
      ...
      <?php if (isset($_POST['form'])) {
        ...
        $price = $_POST['price'];
        $img = $_POST['img'];
        add_new_product($name, $description, $price, $quantity, $img);
      }
      ?>
    </main>
  </div>
