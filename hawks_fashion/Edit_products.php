    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse ">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="Edit_products.php">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
              </svg>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <form method="post">
        <div class="form-group">
          ...
          <input type="text" name="find_user" class="form-control" placeholder="Name or ID of User" required>
        </div>
        <br>
    ...
    <strong>Warning!</strong> Cannot find User.
                ...
                for ($i=0; $i < count($product); $i++) {
                  ...
                  if (isset($product[$i])) {
                    ...
                    echo "
                    <td>
                      <a href='Update_Products.php' class='btn btn-primary btn-block btn-sm my-1' name='form'>Edit</a>
                    </td> ";
                    return;
                  }
                }
